...
class ItemForm extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('item_category', HiddenType::class)
            ->addEventListener(FormEvents::PRE_SET_DATA, function(FormEvent $event) {
                ...
                $form
                    ->add('item_category_desc', TextType::class, array(
                        'label' => 'Category',
                        'label_attr' => array(
                            'class' => 'middle required'
                        ),
                        ...
                        'mapped' => false,
                        'data' => $itemCategory ? $itemCategory->getDescription() : ''
                    ));
            })
            ...
            $builder->get('item_category')->addModelTransformer(new DataTransformer($this->manager, ItemCategoryEntity::class, false));
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' 	  => 'App\Entity\ItemEntity',
            'csrf_protection' => true,
            'csrf_field_name' => '_token',
            // a unique key to help generate the secret token
            'intention'       => 'itemEntity_intention',
            'action'          => 'n',
            'branchId'        => null
