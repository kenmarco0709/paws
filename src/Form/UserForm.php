...
class UserForm extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('prc_no', TextType::class, array(
                'label' => 'Prc License #',
                'label_attr' => array(
                    'class' => 'middle required'
                ),
            ...
            ->add('tin_no', TextType::class, array(
                'label' => 'TIN No.',
                'label_attr' => array(
                    'class' => 'middle required'
                ),
            ...
            ->addEventListener(FormEvents::PRE_SET_DATA, function(FormEvent $event) {
                ...
                $form
                    ->add('prc_expiration_date', TextType::class, array(
                        ...
                        'required' => false,
                        'mapped' => false,
                        'data' => $data->getPrcExpirationDate() ? date_format($data->getPrcExpirationDate(),"m/d/Y") : ''
                    ))
