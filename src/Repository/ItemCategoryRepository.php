...
class ItemCategoryRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if($action !== 'd') {
            ...
            $item_catergoryExist = $this->getEntityManager()->getRepository(ItemCategoryEntity::class)
            ...
            if($action != 'u' && $item_catergoryExist){
                $errors[] = 'Item Catergory already exist.';
            }
