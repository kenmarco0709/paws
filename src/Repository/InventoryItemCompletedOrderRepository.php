...
/**
 * InventoryItemCompletedOrderRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class InventoryItemCompletedOrderRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if(empty($form['supplier'])){
            $errors[] = 'Supplier is should not be empty.';

        }

        if(empty($form['buying_price'])){
            $errors[] = 'Buying Price is should not be empty.';
    ...
    public function ajax_list(array $get){
        ...
        $columns = array(
            array('DATE_FORMAT(iia.`created_at`, "%m/%d/%Y")', 'DATE_FORMAT(iia.`created_at`, "%m/%d/%Y")', 'orderDate'),
            array('s.`description`', 's.`description`', 'supplier' ),
        ...
        $select = "SELECT";
        $from = "FROM `inventory_item_completed_order` iia";
        $joins = " LEFT JOIN `supplier` s ON s.`id` = iia.`supplier_id`";
