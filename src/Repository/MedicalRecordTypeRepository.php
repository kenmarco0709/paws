...
/**
 * MedicalRecordTypeRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class MedicalRecordTypeRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if($action !== 'd') {
            ...
            $medical_record_typeExist = $this->getEntityManager()->getRepository(MedicalRecordTypeEntity::class)
            ...
            if($action != 'u' && $medical_record_typeExist){
                $errors[] = 'Medical Record Type already exist.';
            }
    ...
    public function ajax_list(array $get){
        ...
        $select = "SELECT";
        $from = "FROM `medical_record_type` c";
        $joins = "";
    ...
    public function autocomplete_suggestions($q) {
        ...
        $sql = "
            SELECT
                ...
                c.`description` AS medical_record_type_desc,
                ct.`id` AS city_id,
                ct.`description` AS city_desc
            FROM `medical_record_type` c
