 ...
 */
class AdmissionTypeRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if($action !== 'd') {
            ...
            $admission_typeExist = $this->getEntityManager()->getRepository(AdmissionTypeEntity::class)
            ...
            if($action != 'u' && $admission_typeExist){
                $errors[] = 'AdmissionType already exist.';
            }
