...
class ServiceTypeRepository extends \Doctrine\ORM\EntityRepository
{
    public function validate($form) {
        ...
        if($action !== 'd') {
            ...
            $service_typeExist = $this->getEntityManager()->getRepository(ServiceTypeEntity::class)
            ...
            if($action != 'u' && $service_typeExist){
                $errors[] = 'Service Type already exist.';
            }
