...
/**
 * @ORM\Entity(repositoryClass="App\Repository\MedicalRecordItemRepository")
 * @ORM\Table(name="medical_record_item")
 * @ORM\HasLifecycleCallbacks()
 */

class MedicalRecordItemEntity extends BaseEntity
{
    /**
